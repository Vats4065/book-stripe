...
const {register, login, getUser, findData, book, getAuthorData, addToCart, getCart, updateCart, deleteCart, getOrder} = require('../controllers/regLogApi');
...
router.post('/createBook',checkLogin, uploadFile.single('image'), book);
