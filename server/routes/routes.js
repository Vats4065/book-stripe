...
const {createCustomer, getCard, updateCard, createPayment} = require('../controllers/createcustomer');
...
router.get("/getCard/:email",getCard)
router.post("/updateCard/:email", updateCard)
